				...
				<ul>
					...
					<li>
						<input
							...
							onChange={() => setSelectedPrice('under-500')}
						/>
					...
					<li>
						<input
							...
							onChange={() => setSelectedPrice('1000-1500')}
						/>
					...
					<li>
						<input
							...
							name="price"
							id="over-1500"
							checked={selectedPrice === 'over-1500'}
							onChange={() => setSelectedPrice('over-1500')}
						/>
