				...
				<div className="header__top">
					...
					<div className="header__logo">
						<Link className="header__logo-link" to={PATHS.main}>
							<img className="header__logo-image" src="/images/logo.svg" alt="logo" />
						</Link>
					</div>
										...
										<ul className="sub-menu">
											{category.subCategories.map((subcategory) => (
												<li key={subcategory.id}>
													<Link className='header__menu-link'
														to={`/products&category/${category.nameEn}&subcategory/${subcategory.name}`}
													>
														{subcategory.name}
													</Link>
												</li>
