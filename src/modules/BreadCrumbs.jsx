  ...
  return (
    <div className="breadcrumbs">
      <div className="container breadcrumbs__container">
        <Link className="hover:text-accent" to={PATHS.main}>
          Главная
        </Link>
        <span className="mt-0 mb-0 mr-1 ml-1">
          <svg
            width="8"
            height="10"
            viewBox="0 0 8 10"
        ...
        <Link className="hover:text-accent" to={PATHS.category}>
          Куртки
        </Link>
        <span className="mt-0 mb-0 mr-1 ml-1">
          <svg
        ...
        <Link className="hover:text-accent" to={PATHS.subcategory}>
          Бомберы
        </Link>
        <span className="mt-0 mb-0 mr-1 ml-1">
          <svg
        ...
        <span>Бомбер Gone Crazy хаки</span>
      </div>
    </div>
  );
};
